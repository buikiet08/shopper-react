...
import { CheckCircleFilled, CloseOutlined, MenuOutlined } from '@ant-design/icons'
...
function Header() {
    ...
    const [openMenuMobile, setOpenMenuMobile] = useState(window.innerWidth > 768 ? true : false)
            ...
            <div>
                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-white">
                    <div className="container">
                        ...
                        {
                            openMenuMobile &&
                            <div className={`navbar-collapse ${window.innerWidth <= 768  && 'absolute top-[98px] right-0 w-full bg-white z-10 p-4'}`} id="navbarCollapse">
                                {/* Nav */}
                        ...
                        <ul className={`navbar-nav flex-row items-center ${window.innerWidth <= 768 && 'gap-4'}`}>
                            <li className="nav-item">
                            ...
                            <li className="nav-item ml-lg-n4">
                                <Popover onOpenChange={visible => {
                                    ...
                                    <Button className='w-full bg-black text-white btn-xs mt-2' onClick={() => navigate(PATH.ViewCart)}>Xem giỏ hàng và thanh toán</Button>
                                </>}>
                            ...
                            </li>
                            {
                                user ?
                                    <Dropdown arrow placement='bottomRight' menu={{
                                        ...
                                        <li className="nav-item ml-lg-n4">
                                            <a className={`header-avatar nav-link ${window.innerWidth <= 768 && '!m-0'}`}>
                        ...
                        <div className="navbar-toggler" onClick={() => setOpenMenuMobile(!openMenuMobile)}>
                            {
                                openMenuMobile ? <CloseOutlined /> : <MenuOutlined />
                            }
                        </div>
                    </div>
                </nav>
